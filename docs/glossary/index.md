...
myst:
  html_meta:
    "description": "Terms and definitions used throughout the OpenSPP Documentation."
    "property=og:description": "Terms and definitions used throughout the OpenSPP Documentation."
    "property=og:title": "Glossary"
    "keywords": "OpenSPP, documentation, glossary, term, definition"
---
...
MyST
    [Markedly Structured Text (MyST)](https://myst-parser.readthedocs.io/en/latest/) is a rich and extensible flavor of Markdown, for authoring OpenSPP Documentation.
...
Internationalization
    ...
    OpenSPP is fully internationalized.
